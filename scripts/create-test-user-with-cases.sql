...
BEGIN TRY
    ...
    VALUES (@apply_no1, @test_idno, @test_name, @test_birthday, '3', @now)

    -- Application 2: 7 days ago - Paid, waiting for upload
    INSERT INTO EEC_Apply (apply_no, user_idno, user_name, user_birthday, login_type, createdatetime)
    VALUES (@apply_no2, @test_idno, @test_name, @test_birthday, '3', DATEADD(DAY, -7, @now))

    -- Application 3: 14 days ago - Paid, uploaded, downloadable
    INSERT INTO EEC_Apply (apply_no, user_idno, user_name, user_birthday, login_type, createdatetime)
    VALUES (@apply_no3, @test_idno, @test_name, @test_birthday, '3', DATEADD(DAY, -14, @now))

    -- Application 4: 30 days ago - Completed with downloads
    INSERT INTO EEC_Apply (apply_no, user_idno, user_name, user_birthday, login_type, createdatetime)
    VALUES (@apply_no4, @test_idno, @test_name, @test_birthday, '3', DATEADD(DAY, -30, @now))

    -- Application 5: 60 days ago - Expired/cancelled
    INSERT INTO EEC_Apply (apply_no, user_idno, user_name, user_birthday, login_type, createdatetime)
    VALUES (@apply_no5, @test_idno, @test_name, @test_birthday, '3', DATEADD(DAY, -60, @now))
    ...
    VALUES (@apply_no2, @sub2, @test_idno, @hospital_code, @hospital_name, 'Y', DATEADD(DAY, -6, @now))

    -- Detail 3: Paid
    INSERT INTO EEC_ApplyDetail (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, payed, payed_datetime)
    VALUES (@apply_no3, @sub3, @test_idno, @hospital_code, @hospital_name, 'Y', DATEADD(DAY, -13, @now))

    -- Detail 4: Paid
    INSERT INTO EEC_ApplyDetail (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, payed, payed_datetime)
    VALUES (@apply_no4, @sub4, @test_idno, @hospital_code, @hospital_name, 'Y', DATEADD(DAY, -29, @now))
    ...
    VALUES (@apply_no2, @sub2, @test_idno, @hospital_code, @hospital_name, '01', N'門診病歷', 130, 'Y', DATEADD(DAY, -6, @now), '2')

    -- Price 2-2: Paid, waiting upload - 檢驗報告
    INSERT INTO EEC_ApplyDetailPrice (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, his_type, his_type_name, price, payed, payed_datetime, provide_status)
    VALUES (@apply_no2, @sub2, @test_idno, @hospital_code, @hospital_name, '03', N'檢驗報告', 150, 'Y', DATEADD(DAY, -6, @now), '2')
    ...
    VALUES (@apply_no3, @sub3, @test_idno, @hospital_code, @hospital_name, '01', N'門診病歷', 130, 'Y', DATEADD(DAY, -13, @now), '3', DATEADD(DAY, -12, @now), 0)

    -- Price 3-2: Uploaded, ready for download - X光報告
    INSERT INTO EEC_ApplyDetailPrice (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, his_type, his_type_name, price, payed, payed_datetime, provide_status, provide_datetime, download_count)
    VALUES (@apply_no3, @sub3, @test_idno, @hospital_code, @hospital_name, '04', N'X光報告', 180, 'Y', DATEADD(DAY, -13, @now), '3', DATEADD(DAY, -12, @now), 0)

    -- Price 4-1: Downloaded - 門診病歷
    INSERT INTO EEC_ApplyDetailPrice (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, his_type, his_type_name, price, payed, payed_datetime, provide_status, provide_datetime, download_count)
    VALUES (@apply_no4, @sub4, @test_idno, @hospital_code, @hospital_name, '01', N'門診病歷', 130, 'Y', DATEADD(DAY, -29, @now), '3', DATEADD(DAY, -28, @now), 3)

    -- Price 4-2: Downloaded - 住院病歷
    INSERT INTO EEC_ApplyDetailPrice (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, his_type, his_type_name, price, payed, payed_datetime, provide_status, provide_datetime, download_count)
    VALUES (@apply_no4, @sub4, @test_idno, @hospital_code, @hospital_name, '02', N'住院病歷', 200, 'Y', DATEADD(DAY, -29, @now), '3', DATEADD(DAY, -28, @now), 2)

    -- Price 4-3: Downloaded - 腦波報告
    INSERT INTO EEC_ApplyDetailPrice (apply_no, apply_no_sub, user_idno, hospital_code, hospital_name, his_type, his_type_name, price, payed, payed_datetime, provide_status, provide_datetime, download_count)
    VALUES (@apply_no4, @sub4, @test_idno, @hospital_code, @hospital_name, '05', N'腦波報告', 130, 'Y', DATEADD(DAY, -29, @now), '3', DATEADD(DAY, -28, @now), 1)
