...
namespace EECOnline.Areas.A4.Models
{
    ...
    {
        public C102MForm1Model Form1 { get; set; }

        public C102MForm2Model Form2 { get; set; }
    }

    public class C102MForm1Model : PagingResultsViewModel
    {
        [Display(Name = "醫院名稱")]
        [Control(Mode = Control.TextBox, maxlength = "20", size = "40", placeholder = "請輸入醫院名稱")]
        public string HospitalText { get; set; }

        [Display(Name = "申請人身分證字號")]
        [Control(Mode = Control.TextBox, maxlength = "10", size = "40", placeholder = "請輸入申請人身分證字號")]
        ...
        public IList<C102MForm1GridModel> Form1Grid { get; set; }
    }

    public class C102MForm2Model : PagingResultsViewModel
    {
        [Display(Name = "醫院名稱")]
        [Control(Mode = Control.TextBox, maxlength = "20", size = "40", placeholder = "請輸入醫院名稱")]
        public string HospitalText { get; set; }
        ...
        public IList<C102MForm2GridModel> Form2Grid { get; set; }
    }

    public class C102MForm1GridModel : TblEEC_ApplyDetail
    {
        private IList<TblEEC_Hospital_Api> HospApiList { get; set; }

        public C102MForm1GridModel()
        {
            A4DAO dao = new A4DAO();
        ...
        private List<TblEEC_ApplyDetailPrice> TheData_ApplyDetails
        {
            get
            {
                ...
                {
                    Result = new A4DAO().GetRowList(new TblEEC_ApplyDetailPrice() { apply_no_sub = this.apply_no_sub })
    ...
    public class C102MForm2GridModel : TblEEC_ApplyDetail
    {
        [NotDBField]
