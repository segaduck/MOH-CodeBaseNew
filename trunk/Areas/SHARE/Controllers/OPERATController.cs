...
{
    public class OPERATController : BaseController
    {
        // GET: SHARE/OPERAT
        [HttpGet]
        public ActionResult Index()
        {
            ...
            OPERATFormModel form = new OPERATFormModel();       
            return Index(form);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Index(OPERATFormModel form)
        {
            SessionModel sm = SessionModel.Get();
            ...
            if (ModelState.IsValid)
            {
                ...
                // 查詢結果
                form.Grid = dao.QueryOPERAT(form);
