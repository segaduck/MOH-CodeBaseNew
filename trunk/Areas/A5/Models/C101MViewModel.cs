...
namespace EECOnline.Areas.A5.Models
{
    ...
    public class C101MFormModel : PagingResultsViewModel
    {
        ...
        /// 查詢結果_匯出Excel 
        /// </summary>
        public IList<C101MGridAllModel> GridAll { get; set; }

        /// <summary>
        /// 群組權限一覽_匯出Excel 
        /// </summary>
        public IList<C101MGmapmGridModel> GmapmGrid { get; set; }
    }
    
    /// <summary>
    /// 帳號清單
    /// </summary>
    public class C101MGridModel : TblAMDBURM
    {
        /// <summary>
        /// 0 停用
        /// 1 使用
    ...
    /// 新增 / 編輯 群組
    /// </summary>
    public class C101MDetailModel : TblAMDBURM
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// 群組權限
    /// </summary>
    public class C101MGrpModel :TblAMGRP
    {
        /// <summary>
        /// 帳號
        /// </summary>
        ...
        /// 查詢結果 GridModel
        /// </summary>
        public IList<C101MGrpGridModel> Grid { get; set; }
    }

    /// <summary>
    /// 群組權限
    /// </summary>
    public class C101MGrpGridModel : TblAMGRP
    {
        /// <summary>
        /// 帳號
        /// </summary>
    ...
    /// 帳號清單_匯出Excel
    /// </summary>
    public class C101MGridAllModel : TblAMDBURM
    {
        /// <summary>
        /// 0 停用
        /// 1 使用
    ...
    /// 所屬群組權限_匯出Excel
    /// </summary>
    public class C101MGmapmGridModel : TblAMGRP
    {
        /// <summary>
        /// 群組ID
        /// </summary>
