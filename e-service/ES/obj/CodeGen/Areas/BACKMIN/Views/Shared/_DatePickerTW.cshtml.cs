...
namespace ES.Areas.BACKMIN.Views.Shared
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/BACKMIN/Views/Shared/_DatePickerTW.cshtml")]
...
"t).find(\'.open-datepicker\').parent().parent().attr(\'disabled\') != \"disabled\" ) {" +
"\r\n                    event.preventDefault();\r\n                    $(target).dat" +
"a(\"DateTimePicker\").show();\r\n                }\r\n            }\r\n            catch" +
" (ex) {\r\n                //blockAlert(\"[initDatePicker] \" + ex.message);\r\n      " +
"      }\r\n            finally {\r\n                //20181012 加入若在頁面內有 dateTimePick" +
"erShowCallback() 方法時，就自動執行 dateTimePickerShowCallback 方法。\r\n                var f" +
"unc = __dtpFindFunc(\"dateTimePickerShowCallback\");\r\n                if (func) fu" +
"nc.call(window, this);\r\n            }\r\n        });\r\n    }\r\n\r\n    //20180927 增加數字" +
    ...
    function onDPChangeShowZHDate(e, callback) {
        ...
        if (e.date) {
            ...
            if (callback) {
                ...
                var func = __dtpFindFunc(""dateTimePickerShowCallback"");
...
"       var dateText = $(txtInput).val();\r\n            if (dateText.length == 7)\r" +
"\n            {\r\n                dateText = dateText.substring(0, 3) + \"/\" + date" +
"Text.substring(3, 5) + \"/\" + dateText.substring(5,7);          \r\n            }\r\n" +
"            if (dateText.length == 6) {\r\n                dateText = \"0\" + dateTe" +
"xt.substring(0, 2) + \"/\" + dateText.substring(2, 4) + \"/\" + dateText.substring(4" +
", 6);\r\n            }\r\n            var dateArr = dateText.split(\'\\/\');\r\n         " +
"   if (dateText && dateText.trim().length > 0) {\r\n                //20180927 將民國" +
"年補齊三位數\r\n                //dateArr[0] = parseInt(dateArr[0], 10);\r\n              " +
"  dateText = dateArr.join(\"/\");\r\n               \r\n                var regex = /^" +
"[0-9][0-9][0-9]\\/[0-1][0-9]\\/[0-3][0-9]$/;\r\n                if (regex.test(dateT" +
"ext.trim())) {\r\n                    var year = parseInt(dateArr[0], 10);\r\n      " +
"              if (!isNaN(year)) {\r\n                        dateArr[0] = year + 1" +
"911;\r\n                        //dateArr[0] = year;\r\n                        hidV" +
"al = dateArr.join(\'/\');\r\n\r\n                        //20180927 將民國年補齊三位數\r\n       " +
"                 dateArr = dateText.split(\'\\/\');\r\n                        dateAr" +
"r[0] = _dpTWLpad(dateArr[0], 3, \"0\");\r\n                        dateText = dateAr" +
"r.join(\"/\");\r\n\r\n                        $(hidInput).val(hidVal);\r\n              " +
"          $(txtInput).val(dateText);\r\n\r\n                        if (callback) {\r" +
"\n                            callback(hidVal, dateText);\r\n                      " +
"  }\r\n                    }\r\n                } else {\r\n                    blockA" +
"lert(\"日期格式不正確！（範例：1080101 或是 108/01/01）\");\r\n                    $(txtInput).val(" +
"\'\');\r\n                    $(hidInput).val(\'\');\r\n                    if (callback" +
") {\r\n                        callback(\'\', \'\');\r\n                    }\r\n         " +
"           else {\r\n                        var func = __dtpFindFunc(\"dateTimePic" +
"kerShowCallback\");\r\n                        if (func) func.call(window, this);\r\n" +
"                    }\r\n                }\r\n            } else {\r\n                " +
"$(hidInput).val(\'\');\r\n                if (callback) {\r\n                    callb" +
"ack(\'\', \'\');\r\n                }\r\n            }\r\n        });\r\n    }\r\n</script>\r\n\r" +
