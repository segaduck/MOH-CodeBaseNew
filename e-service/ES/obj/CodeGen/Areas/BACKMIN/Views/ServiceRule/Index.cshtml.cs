...
namespace ES.Areas.BACKMIN.Views.ServiceRule
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/BACKMIN/Views/ServiceRule/Index.cshtml")]
    public partial class Index : System.Web.Mvc.WebViewPage<dynamic>
    {
        ...
        public override void Execute()
        {
            ...
            #line 1 "..\..\Areas\BACKMIN\Views\ServiceRule\Index.cshtml"
  
    Layout = "~/Areas/BACKMIN/Views/Shared/_Layout.cshtml";

    ViewBag.Title = "案件稽催設定";
    ViewBag.FunctionTitle = "案件稽催設定";
    ViewBag.Script = @"
var categoryMenu = {
async: {
enable: true,
url: """ + Url.Action("GetCategory", "ServiceRule") + @""",
autoParam:[""id""],
...
childNodes[i].click = 'doRuleList('+childNodes[i].id+')';
}
return childNodes;
}
...
try {
    ...
    if ( id != 0 ) doRuleList(" + ViewBag.ListId + @");
...
function doRuleList(id) {
var url = '" + Url.Action("List", "ServiceRule") + @"/' + id + ' #detail1';
...
WriteLiteral("></i>首頁 / 案件設定 / ");
            ...
            #line 69 "..\..\Areas\BACKMIN\Views\ServiceRule\Index.cshtml"
...
WriteLiteral("></i>");
            ...
            #line 72 "..\..\Areas\BACKMIN\Views\ServiceRule\Index.cshtml"
                                                 Write(ViewBag.FunctionTitle);
...
WriteLiteral(" value=\"預設稽催設定\"");

WriteAttribute("onclick", Tuple.Create(" onclick=\"", 1988), Tuple.Create("\"", 2059)
, Tuple.Create(Tuple.Create("", 1998), Tuple.Create("document.location.href=\'", 1998), true)
            
            #line 75 "..\..\Areas\BACKMIN\Views\ServiceRule\Index.cshtml"
                      , Tuple.Create(Tuple.Create("", 2022), Tuple.Create<System.Object, System.Int32>(Url.Action("Setup", "ServiceRule")
            
            #line default
            #line hidden
, 2022), false)
, Tuple.Create(Tuple.Create("", 2057), Tuple.Create("\';", 2057), true)
);
