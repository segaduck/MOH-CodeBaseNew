...
namespace ES.Helpers
{
    ...
    /// </summary>
    public static class RadioGroupExtension
    {
        ...
        /// <returns></returns>
        public static MvcHtmlString RadioGroupFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<SelectListItem> listItems, object htmlAttributes = null)
        {
            // 2017.07.13, eric
            ...
            foreach (SelectListItem item in listItems)
            {
                ...
                divTag.InnerHtml += String.Format("<div class=\"radio\" id=\"radio_{1}_{2}\">" +
                    "<label for=\"{1}_{2}\">" +
