...
{
    public class Form005001Action : FormBaseWordAction
    {
        public Form005001Action(SqlConnection conn)
        {
            this.conn = conn;
        }

        public Form005001Action(SqlConnection conn, SqlTransaction tran)
        {
            this.conn = conn;
            this.tran = tran;
        }
        ...
        public Dictionary<string, object> GetData(String id) 
        {
            ...
            string querySQL = @"
                SELECT A.SRV_ID, A.APP_ID, A.APP_TIME, A.NAME AS MF_NAME, A.ENAME AS MF_ENAME,
                    ...
                    B.EFFICACY, B.EFFICACY_E, B.PC_SCALE_1,B.PC_SCALE_1E, B.PC_SCALE_21, B.PC_SCALE_22, B.PC_SCALE_23, B.PC_SCALE_24,B.PC_SCALE_2E,
        ...
        public List<Dictionary<string, object>> GetList1(string id)
        {
            ...
            string querySQL = @"SELECT * FROM APPLY_005001_PC WHERE APP_ID = @APP_ID";
        ...
        public List<Dictionary<string, object>> GetList2(string id)
        {
            ...
            string querySQL = @"SELECT * FROM APPLY_005001_DI WHERE APP_ID = @APP_ID";
        ...
        public byte[] GetApplyWord(string id)
        {
            ...
            string templateFile = path + "/產銷證明(GMP)空白表格_0029536000" + FileNameTag + ".docx";
        ...
        private string GetCont(Dictionary<string, object> data, List<Dictionary<string, object>> list1, List<Dictionary<string, object>> list2)
        {
            ...
            string fontTbCName = "<w:tc><w:tcPr><w:tcW w:w=\"18%\" w:type=\"pct\"/></w:tcPr><w:p><w:pPr><w:spacing w:line=\"240\" w:lineRule=\"exact\"/></w:pPr><w:r><w:rPr><w:sz w:val=\"14\"/><w:szCs w:val=\"14\"/><w:rFonts w:ascii=\"Times New Roman\" w:eastAsia=\"新細明體\" /></w:rPr><w:t>";
            ...
            string fontTbUnit = "<w:tc><w:tcPr><w:tcW w:w=\"3%\" w:type=\"pct\"/></w:tcPr><w:p><w:pPr><w:spacing w:line=\"240\" w:lineRule=\"exact\"/></w:pPr><w:r><w:rPr><w:sz w:val=\"14\"/><w:szCs w:val=\"14\"/><w:rFonts w:ascii=\"Times New Roman\" w:eastAsia=\"新細明體\" /></w:rPr><w:t>";
            ...
            {                
                ...
                {                   
                    ...
                    sb.Append(fontTbUnit).Append(list1[i]["PC_UNIT"]).Append(fontTbE);
                    
                    if (j == 0)
                       sb.Append(fontTbSpace).Append("").Append(fontTbE);
                }
                if (list1.Count == 1 && i==0)
                {
        ...
        private string AddRow(Dictionary<string, object> data,string key)
        {
            ...
            if (!String.IsNullOrEmpty(key))
            {
                if (key == "MF_REMARK")
                {
                    ...
                    //sb.Append("<w:tblPr><w:tblStyle w:val=\"TableGrid\" /><w:tblBorders><w:top w:val='single' w:sz='4' w:space='0' w:color='auto'/><w:left w:val='single' w:sz='4' w:space='0' w:color='auto'/><w:bottom w:val='single' w:sz='4' w:space='0' w:color='auto'/><w:right w:val='single' w:sz='4' w:space='0' w:color='auto'/></w:tblBorders></w:tblPr>");
                    sb.Append("<w:tblGrid><w:gridCol /><w:gridCol /><w:gridCol /><w:gridCol /></w:tblGrid>");
