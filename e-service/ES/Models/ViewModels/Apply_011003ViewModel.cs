...
namespace ES.Models.ViewModels
{
    ...
    {      
        ...
        public string BIRTHDAY_AD
        {
            ...
            set
            {
                BIRTHDAY = HelperUtil.DateTimeToTwString(HelperUtil.TransToDateTime(value), "/");         // YYYMMDD 民國年 使用者看到
            }
        }
        ...
        public string GRADUATION_TEXT { get; set; }
        public string GRADUATION_MONTH_TEXT { get; set; }
        ...
        public HttpPostedFileBase FILE_FIDC { get; set; }
        ...
        public HttpPostedFileBase FILE_BIDC { get; set; }
        ...
        public HttpPostedFileBase FILE_PIC { get; set; }
        ...
        public HttpPostedFileBase FILE_GRAD { get; set; }
        ...
        public HttpPostedFileBase FILE_GRADOFF { get; set; }
        ...
        public HttpPostedFileBase FILE_FONSRV { get; set; }
        ...
        public HttpPostedFileBase FILE_DOMICILE { get; set; }
        ...
        public HttpPostedFileBase FILE_SCHOOL { get; set; }
        ...
        public HttpPostedFileBase FILE_OTHER { get; set; }
    ...
    /// 服務經歷
    /// </summary>
    public class Apply_011003SRVLSTModel : APPLY_011003_SRVLST
    {
        /// <summary>
        /// 序號
        /// </summary>
        ...
        public HttpPostedFileBase FILE_PICRGB { get; set; }
        ...
        public HttpPostedFileBase FILE_SRVPROVE { get; set; }
        ...
        public HttpPostedFileBase FILE_LABOR { get; set; }
        ...
        /// </summary>
        [Display(Name = "特殊需求")]
        public bool SRVLST_DEMAND_1 { get; set; }
        ...
        public HttpPostedFileBase FILE_LEGAL { get; set; }
        ...
        /// </summary>
        [Display(Name = "特殊需求")]
        public bool SRVLST_DEMAND_2 { get; set; }
        public string SRVLST_DEMAND_2_TEST { get; set; }
        ...
        public HttpPostedFileBase FILE_CHARTER { get; set; }
