...
namespace ES.Models.ViewModels
{
    ...
    public class Apply_005005ViewModel
    {
        public Apply_005005ViewModel()
        {
            ...
            this.FormBack = new Apply_005005Form2Model();
            this.Detail = new Apply_005005Form2Model();
        }

        public Apply_005005FormModel Form { get; set; }

        public Apply_005005Form2Model FormBack { get; set; }

        public Apply_005005Form2Model Detail { get; set; }
    }
