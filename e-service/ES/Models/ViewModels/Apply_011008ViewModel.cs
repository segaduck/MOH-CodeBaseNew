...
{
    /// <summary>
    /// APPLY_011008 (衛福部)社工師證書換發（更名或汙損）
    /// </summary>
    public class Apply_011008ViewModel
    {
        public Apply_011008ViewModel()
        {
            this.Form = new Apply_011008FormModel();
        }
    ...
    /// 表單填寫
    /// </summary>
    public class Apply_011008FormModel : ApplyModel
    {
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011008AppDocModel : ApplyModel
    {
        /// <summary>
        /// 申請類別：（1:更名或2:汙損）
        /// </summary>
        ...
        /// 完成畫面
        /// </summary>
        public class Apply_011008DoneModel
        {
            /// <summary>
            /// 狀態
            /// </summary>
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011008DetailModel : ApplyModel
    {
