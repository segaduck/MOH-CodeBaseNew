...
namespace ES.Models.ViewModels
{
    ...
    public class Apply_010001FormModel : TblAPPLY_010001
    {
        ...
        {
            APPFIL = new GoodsDynamicGrid<APPLY_010001_APPFILModel>();
            APPFIL.APP_ID = this.APP_ID;
            APPFIL.model = new APPLY_010001_APPFILModel();
            APPFIL.GetGoodsList();
        ...
        public Apply_010001FormModel(string APP_ID)
        {
            APPFIL = new GoodsDynamicGrid<APPLY_010001_APPFILModel>();
            APPFIL.APP_ID = this.APP_ID;
            this.APP_ID = APP_ID;
        ...
        [Control(Mode = Control.Goods, block_toggle_group = 4, EditorViewName = "GoodsDynamicGrid010001")]
        ...
        [Display(Name = "申請目的及用途")]
        [Control(Mode = Control.CheckBoxList, block_toggle_group = 5, IsOpenNew = true, block_toggle = true, toggle_name = "申請事由")]
        [Required]
    ...
    /// 確認連結
    /// </summary>
    public class Apply_010001CheckModel
    {
        /// <summary>
        /// 狀態
        /// </summary>
    ...
    public class Apply_010001DocModel : ApplyModel
    {
        ...
        public Apply_010001DocModel(string APP_ID)
        {
            APPFIL = new GoodsDynamicGrid<APPLY_010001_APPFILModel>();
