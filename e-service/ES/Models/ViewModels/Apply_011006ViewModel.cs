...
{
    /// <summary>
    /// APPLY_011006 專科社會工作師證書換發（更名）
    /// </summary>
    public class Apply_011006ViewModel
    {
        public Apply_011006ViewModel()
        {
            this.Form = new Apply_011006FormModel();
        }

        /// <summary>
        /// FormModel
        /// </summary>
        public Apply_011006FormModel Form { get; set; }

        /// <summary>
        /// 補件表單
        /// </summary>
        public Apply_011006AppDocModel AppDoc { get; set; }
    }
    /// <summary>
    /// 表單填寫
    /// </summary>
    public class Apply_011006FormModel : ApplyModel
    {
        /// <summary>
        /// 申請日期
        /// </summary>
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011006AppDocModel : ApplyModel
    {
        /// <summary>
        /// 補件狀態
        /// </summary>
        ...
        /// 完成畫面
        /// </summary>
        public class Apply_011006DoneModel
        {
            /// <summary>
            /// 狀態
            /// </summary>
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011006DetailModel : ApplyModel
    {
        /// <summary>
        /// 補件欄位字串
        /// </summary>
