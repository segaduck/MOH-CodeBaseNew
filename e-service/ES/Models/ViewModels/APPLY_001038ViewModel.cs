...
namespace ES.Models.ViewModels
{
    ...
    public class Apply_001038FormModel : Apply_001038Model
    {
        ...
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 2, group = 4)]
        public string Dest_ORG_NAME { get; set; }

        [Display(Name = "電話")]
        [Required]
        [Control(Mode = Control.Tel, IsOpenNew = true, block_toggle_group = 2, group = 5)]
        public string Dest_ORG_TEL { get; set; }

        [Display(Name = "E-MAIL")]
        [Required]
        [Control(Mode = Control.EMAIL, IsOpenNew = true, block_toggle_group = 2, group = 6)]
        ...
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 2, group = 8, size = "59")]
        ...
        [Display(Name = "輸入之目的")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 2, group = 12, size = "59")]
        ...
        [Display(Name = "申請機構名稱")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_BIG_id = "EXPORT", block_toggle = true, toggle_name = "生殖細胞及胚胎輸出", block_toggle_group = 3, group = 13, block_toggle_id = "SellOut", size = "59")]
        ...
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 3, group = 18, size = "59")]
        ...
        //    }
        //}
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 3, group = 23, size = "59")]
        public string Sell_OTH_ADDR { get; set; }

        [Display(Name = "輸出之目的")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 3, group = 21, size = "59")]
        ...
        /// 身份證字號
        /// </summary
        [Display(Name = "身分證字號或護照號碼")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle = true, toggle_name = "委託人資料", block_toggle_group = 4, group = 30)]
        ...
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 4, group = 32, size = "59")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 4, group = 35)]
        ...
        [Required]
        [Control(Mode = Control.Tel, IsOpenNew = true, block_toggle_group = 4, group = 36)]
        ...
        [Required]
        [Control(Mode = Control.EMAIL, IsOpenNew = true, block_toggle_group = 4, group = 37)]
        ...
        [Display(Name = "委託人傳真")]
        //[Required]
        [Control(Mode = Control.Tel, IsOpenNew = true, block_toggle_group = 4, group = 38)]
        public string TAX_ORG_FAX { get; set; }

        [Display(Name = "起始日期")]
        [Required]
        [Control(Mode = Control.DatePicker, IsOpenNew = true, block_toggle_group = 4, group = 39)]
        ...
        /// </summary>
        [Display(Name = "啟運口岸")]
        [Control(Mode = Control.CountryPort, IsOpenNew = true, block_toggle_group = 4, group = 41)]
        ...
        [Display(Name = "申請用途")]
        [Required]
        [Control(Mode = Control.DropDownList, IsOpenNew = true, block_toggle_group = 6, block_toggle = true, toggle_name = "其他資料<span style='color:red'>*當次全部檔案傳輸上傳最大容量允許為5MB</span>")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "委託人身分證明文件影本(如:國民身分證統一編號或護照)", block_toggle_group = 6, form_id = "form_DOC_TYP_01_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_01")]
        public string DOC_COD_01 { get; set; }
        /// <summary>
        /// 檢附文件說明一
        /// </summary>
        [Display(Name = "檢附文件說明一")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_01")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型一", block_toggle_group = 6, form_id = "form_DOC_FILE_01")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "輸入或輸出申請書", block_toggle_group = 6, form_id = "form_DOC_TYP_02_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_02")]
        public string DOC_COD_02 { get; set; }
        /// <summary>
        /// 檢附文件說明二
        /// </summary>
        [Display(Name = "檢附文件說明二")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_02")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二", block_toggle_group = 6, form_id = "form_DOC_FILE_02")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "委託書", block_toggle_group = 6, form_id = "form_DOC_TYP_03_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_03")]
        public string DOC_COD_03 { get; set; }
        /// <summary>
        /// 檢附文件說明三
        /// </summary>
        [Display(Name = "檢附文件說明三")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_03")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型三", block_toggle_group = 6, form_id = "form_DOC_FILE_03")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "切結書", block_toggle_group = 6, form_id = "form_DOC_TYP_04_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_04")]
        public string DOC_COD_04 { get; set; }
        /// <summary>
        /// 檢附文件說明四
        /// </summary>
        [Display(Name = "檢附文件說明四")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_04")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型四", block_toggle_group = 6, form_id = "form_DOC_FILE_04")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "輸出或輸入國(地)主管機關開立，並經我國駐外單位或其委託之機構驗證之輸出或輸入許可證明，或足以證明輸出或輸入國(地)未管制輸出或輸入文件", block_toggle_group = 6, form_id = "form_DOC_TYP_05_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_05")]
        public string DOC_COD_05 { get; set; }
        /// <summary>
        /// 檢附文件說明五
        /// </summary>
        [Display(Name = "檢附文件說明五")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_05")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型五", block_toggle_group = 6, form_id = "form_DOC_FILE_05")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
            , checkBoxWord = "輸入國(地)承接儲存生殖細胞或胚胎之機構開立，並經我國駐外單位或其委託之機構驗證之承接同意書。", block_toggle_group = 6, form_id = "form_DOC_TYP_06_SHOW")]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_06")]
        public string DOC_COD_06 { get; set; }
        /// <summary>
        /// 檢附文件說明六
        /// </summary>
        [Display(Name = "檢附文件說明六")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_06")]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型六", block_toggle_group = 6, form_id = "form_DOC_FILE_06")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "來本署藥政處藥品臨床試驗許可函(如進行藥物臨床試驗者必備)", block_toggle_group = 6, form_id = "form_DOC_TYP_07_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_07")]
        //public string DOC_COD_07 { get; set; }
        ///// <summary>
        ///// 檢附文件說明七
        ///// </summary>
        //[Display(Name = "檢附文件說明七")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_07")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型七", block_toggle_group = 6, form_id = "form_DOC_FILE_07")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "捐贈者年齡、器官、組織或細胞摘取時間等資料(進口眼角膜得於輸入後一個月內補正)", block_toggle_group = 6, form_id = "form_DOC_TYP_08_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_08")]
        //public string DOC_COD_08 { get; set; }
        ///// <summary>
        ///// 檢附文件說明八
        ///// </summary>
        //[Display(Name = "檢附文件說明八")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_08")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型八", block_toggle_group = 6, form_id = "form_DOC_FILE_08")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "教學課程計畫書", block_toggle_group = 6, form_id = "form_DOC_TYP_09_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_09")]
        //public string DOC_COD_09 { get; set; }
        ///// <summary>
        ///// 檢附文件說明九
        ///// </summary>
        //[Display(Name = "檢附文件說明九")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_09")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型九", block_toggle_group = 6, form_id = "form_DOC_FILE_09")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "藥物臨床試驗許可函", block_toggle_group = 6, form_id = "form_DOC_TYP_10_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_10")]
        //public string DOC_COD_10 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十
        ///// </summary>
        //[Display(Name = "檢附文件說明十")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_10")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十", block_toggle_group = 6, form_id = "form_DOC_FILE_10")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "臨床試驗摘要", block_toggle_group = 6, form_id = "form_DOC_TYP_11_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_11")]
        //public string DOC_COD_11 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十一
        ///// </summary>
        //[Display(Name = "檢附文件說明十一")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_11")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十一", block_toggle_group = 6, form_id = "form_DOC_FILE_11")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "檢體數量概估說明(表)", block_toggle_group = 6, form_id = "form_DOC_TYP_12_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_12")]
        //public string DOC_COD_12 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十二
        ///// </summary>
        //[Display(Name = "檢附文件說明十二")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_12")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十二", block_toggle_group = 6, form_id = "form_DOC_FILE_12")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "IRB審核通過之國外擔保書", block_toggle_group = 6, form_id = "form_DOC_TYP_13_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_13")]
        //public string DOC_COD_13 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十三
        ///// </summary>
        //[Display(Name = "檢附文件說明十三")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_13")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十三", block_toggle_group = 6, form_id = "form_DOC_FILE_13")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "捐贈者同意文件（或來源單位證明捐者同意捐贈之文件）", block_toggle_group = 6, form_id = "form_DOC_TYP_14_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_14")]
        //public string DOC_COD_14 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十四
        ///// </summary>
        //[Display(Name = "檢附文件說明十四")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_14")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十四", block_toggle_group = 6, form_id = "form_DOC_FILE_14")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "捐贈者同意範例文件", block_toggle_group = 6, form_id = "form_DOC_TYP_15_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_15")]
        //public string DOC_COD_15 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十五
        ///// </summary>
        //[Display(Name = "檢附文件說明十五")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_15")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十五", block_toggle_group = 6, form_id = "form_DOC_FILE_15")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "與單位合作之相關證明文件", block_toggle_group = 6, form_id = "form_DOC_TYP_16_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_16")]
        //public string DOC_COD_16 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十六
        ///// </summary>
        //[Display(Name = "檢附文件說明十六")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_16")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十六", block_toggle_group = 6, form_id = "form_DOC_FILE_16")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "研究單位同意試驗文件（如：IRB許可函）", block_toggle_group = 6, form_id = "form_DOC_TYP_17_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_17")]
        //public string DOC_COD_17 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十七
        ///// </summary>
        //[Display(Name = "檢附文件說明十七")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_17")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十七", block_toggle_group = 6, form_id = "form_DOC_FILE_17")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "輸入貨品之檢驗證明文件或無污染證明文件", block_toggle_group = 6, form_id = "form_DOC_TYP_18_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_18")]
        //public string DOC_COD_18 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十八
        ///// </summary>
        //[Display(Name = "檢附文件說明十八")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_18")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十八", block_toggle_group = 6, form_id = "form_DOC_FILE_18")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "藥物臨床試驗許可函及/或試驗計畫摘要", block_toggle_group = 6, form_id = "form_DOC_TYP_19_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_19")]
        //public string DOC_COD_19 { get; set; }
        ///// <summary>
        ///// 檢附文件說明十九
        ///// </summary>
        //[Display(Name = "檢附文件說明十九")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_19")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十九", block_toggle_group = 6, form_id= "form_DOC_FILE_19")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "原核准輸出同意函", block_toggle_group = 6, form_id = "form_DOC_TYP_20_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 6, form_id = "form_DOC_COD_20")]
        //public string DOC_COD_20 { get; set; }
        ///// <summary>
        ///// 檢附文件說明二十
        ///// </summary>
        //[Display(Name = "檢附文件說明二十")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_20")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十", block_toggle_group = 6, form_id = "form_DOC_FILE_20")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "細胞治療技術施行計畫核准函", block_toggle_group = 6, form_id = "form_DOC_TYP_21_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "21", block_toggle_group = 6, form_id = "form_DOC_COD_21")]
        //public string DOC_COD_21 { get; set; }
        ///// <summary>
        ///// 檢附文件說明二十一
        ///// </summary>
        //[Display(Name = "檢附文件說明二十一")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_21")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十一", block_toggle_group = 6, form_id = "form_DOC_FILE_21")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true
        //    , checkBoxWord = "細胞製備場所GTP認可函", block_toggle_group = 6, form_id = "form_DOC_TYP_22_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "22", block_toggle_group = 6, form_id = "form_DOC_COD_22")]
        //public string DOC_COD_22 { get; set; }
        ///// <summary>
        ///// 檢附文件說明二十二
        ///// </summary>
        //[Display(Name = "檢附文件說明二十二")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_22")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十二", block_toggle_group = 6, form_id = "form_DOC_FILE_22")]
        ...
        //[Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "其他", block_toggle_group = 6, form_id = "form_DOC_TYP_23_SHOW")]
        ...
        //[Control(Mode = Control.TextBox, IsOpenNew = true, size = "23", block_toggle_group = 6, form_id = "form_DOC_COD_23")]
        //public string DOC_COD_23 { get; set; }
        ///// <summary>
        ///// 檢附文件說明二十三
        ///// </summary>
        //[Display(Name = "檢附文件說明二十三")]
        //[Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 6, form_id = "form_DOC_TXT_23")]
        ...
        //[Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十三", block_toggle_group = 6, form_id = "form_DOC_FILE_23")]
