...
{
    /// <summary>
    /// APPLY_011007 (衛福部)社工師證書核發（中文）
    /// </summary>
    public class Apply_011007ViewModel
    {
        public Apply_011007ViewModel()
        {
            this.Form = new Apply_011007FormModel();
        }
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011007AppDocModel : ApplyModel
    {
        /// <summary>
        ...
        /// 完成畫面
        /// </summary>
        public class Apply_011007DoneModel
        {
            /// <summary>
            /// 狀態
            /// </summary>
    ...
    /// 補件表單
    /// </summary>
    public class Apply_011007DetailModel : ApplyModel
    {
