...
namespace ES.Models.Entities
{
    ...
    /// 
    /// </summary>
    public class Apply_001038_SELL
    {
        public string APP_ID { get; set; }
        public string ORG_UNITNAME { get; set; }
        public string ORG_NAME { get; set; }
        public string ORG_LIC_NUM { get; set; }
        public string ORG_TEL { get; set; }
        public string ORG_EMAIL { get; set; }
        public string OTH_UNITNAME { get; set; }
        public string OTH_NAME { get; set; }
        public string OTH_TEL { get; set; }
        public string OTH_EMAIL { get; set; }
        public string OTH_ZIP { get; set; }
