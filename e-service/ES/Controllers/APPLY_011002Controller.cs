...
namespace ES.Controllers
{
    ...
    public class Apply_011002Controller : BaseController
    {
        ...
        public ActionResult Apply(Apply_011002FormModel model)
        {
            ...
            {
                logger.Debug("Apply_011002.FileName:" + model.FILE_IDNF_TEXT);
                // 允許的附檔名（全小寫）
            ...
            {
                logger.Debug("Apply_011002.FileName:" + model.FILE_IDNB_TEXT);
                // 允許的附檔名（全小寫）
                var validExts = new[] { "pdf", "jpg", "jpeg", "bmp", "png", "gif", "tif", "zip", "doc", "docx", "odt", "odf", "ods", "xls", "xlsx", "ppt", "pptx" };
                // 取得副檔名並轉小寫
            ...
            {
                logger.Debug("Apply_011002.FileName:" + model.FILE_PHOTO_TEXT);
                // 允許的附檔名（全小寫）
                var validExts = new[] { "pdf", "jpg", "jpeg", "bmp", "png", "gif", "tif", "zip", "doc", "docx", "odt", "odf", "ods", "xls", "xlsx", "ppt", "pptx" };
                // 取得副檔名並轉小寫
            ...
            {
                logger.Debug("Apply_011002.FileName:" + model.FILE_HOUSEHOLD_TEXT);
                // 允許的附檔名（全小寫）
                var validExts = new[] { "pdf", "jpg", "jpeg", "bmp", "png", "gif", "tif", "zip", "doc", "docx", "odt", "odf", "ods", "xls", "xlsx", "ppt", "pptx" };
                // 取得副檔名並轉小寫
        ...
        public ActionResult AppDoc(string APP_ID)
        {
            ...
            //Apply_011002DetailModel detail = new Apply_011002DetailModel();
        ...
        #region 申請單套表
        //[HttpPost]
        //[DisplayName("011002_申請單套表")]
        //public void PreviewApplyForm(Apply_011002FormModel Form)
        //{
        //    //□ ■
        //    string path = Server.MapPath("~/Sample/apply011002.docx");
        //    byte[] buffer = null;
