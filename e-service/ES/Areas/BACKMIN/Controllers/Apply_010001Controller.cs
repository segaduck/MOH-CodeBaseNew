...
");
        ...
        /// <param name="app_id"></param>
        /// <returns></returns>
        public Apply_010001FormModel GetApply010001Data(string app_id)
        {
            Apply_010001FormModel model = new Apply_010001FormModel();
            var APP_ID = app_id;
            BackApplyDAO dao = new BackApplyDAO();
            SessionModel sm = SessionModel.Get();
            model.APPFIL = new List<APPLY_010001_APPFILModel>();
            ...
            TblAPPLY_010001 a010 = new TblAPPLY_010001();
            a010.APP_ID = APP_ID;
            ...
            // CHECK 特殊處理
            var CHECKNO_Str = "";
            TblAPPLY_010001_CHK chk = new TblAPPLY_010001_CHK();
            chk.APP_ID = APP_ID;
            chk.TYPE = "0";
            chk.SEQ_NO = 0;
            ...
            // 取檔案
            model.FileList = dao.GetFileList_010001(model.APP_ID);
