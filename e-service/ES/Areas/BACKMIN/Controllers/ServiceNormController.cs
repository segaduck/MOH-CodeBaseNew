...
namespace ES.Areas.Admin.Controllers
{
    ...
    public class ServiceNormController : BaseController
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            if (id != null)
            {
                ...
                {
                    conn.Open();
                    ServiceNormAction action = new ServiceNormAction(conn);
            ...
            this.SetVisitRecord("ServiceNorm", "Index", "相關規範管理");
        ...
        {
            ServiceNormNewModel model = null;
        ...
        [HttpPost]
        public ActionResult New(ServiceNormNewModel model)
        {
            if (ModelState.IsValid)
            {
                if (Request.Files.Count > 0 && !String.IsNullOrEmpty(Request.Files[0].FileName))
                {
                    string dir = DataUtils.GetConfig("FOLDER_SERVICE_NORM") + model.ServiceId + "\\";
                ...
                using (SqlConnection conn = GetConnection())
                {
                    ...
                    ServiceNormAction action = new ServiceNormAction(conn, tran);
                ...
                if (isInsert)
                {
                    return RedirectToAction("List", new { @id = model.ServiceId });
                }
        ...
        {
            ServiceNormEditModel model = new ServiceNormEditModel();
            model.ServiceId = id;
            model.FileId = fid;
        ...
        [ValidateAntiForgeryToken]
        [HttpPost]
        public ActionResult Edit(ServiceNormEditModel model)
        {
            if (ModelState.IsValid)
            {
                if (Request.Files.Count > 0 && !String.IsNullOrEmpty(Request.Files[0].FileName))
        ...
        public ActionResult Download(string id, int fid)
        {
            ...
            string filePath = DataUtils.GetConfig("FOLDER_SERVICE_NORM") + id + "\\" + model.FileName;
