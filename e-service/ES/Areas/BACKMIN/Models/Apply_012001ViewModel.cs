...
namespace ES.Areas.Admin.Models
{
    ...
    public class Apply_012001FormModel : TblAPPLY_012001
    {
        ...
        public string NPIN_E_ADDR_CODE_ADDR
        {
            ...
            {
                var dao = new MyKeyMapDAO();
                KeyMapModel kmm = dao.GetCityTownName(NPIN_E_ADDR_CODE);
                return (kmm != null ? kmm.TEXT : "");
            }
        }
        ...
        public string LPIN_E_UNIT_ADDR_CODE_ADDR
        {
            ...
            {
                var dao = new MyKeyMapDAO();
                KeyMapModel kmm = dao.GetCityTownName(LPIN_E_UNIT_ADDR_CODE);
                return (kmm != null ? kmm.TEXT : "");
            }
        }
        ...
        public IList<APPLY_012001_APPFILModel> APPFIL { get; set; }
        ...
        public Apply_012001FileModel FileList { get; set; }
    ...
    /// 檔案下載
    /// </summary>
    public class Apply_012001FileModel
    {
        public Apply_012001FileModel()
        {
