...
namespace ES.Areas.BACKMIN.Models
{
    public class Apply_005003ViewModel
    {
        ...
        /// 成分內容
        /// </summary>
        [Control(Mode = Control.Goods, block_toggle_group = 5, EditorViewName = "GoodsDynamicGrid005003")]
        ...
        public Apply_005003ViewModel()
        {
            ...
            this.Detail = new Apply_005003FormModel();
        ...
        public Apply_005003FormModel Detail { get; set; }

        //public Apply_005003PreviewModel Preview { get; set; }
    }
    ...
    public class Apply_005003FormModel : ApplyModel
    {
        ...
        {
            get { return (APP_EXT_DATE.HasValue ? HelperUtil.DateTimeToTwString(APP_EXT_DATE) : null); }
        ...
        /// </summary>
        [Display(Name = "2A.4該藥品許可證是否有經認可之試驗佐證")]
    ...
    public class Apply_005003Form2Model : Apply_005003FormModel { }

    #region 沒用到

    //public class Apply_005003AppDocModel : ApplyModel
    //{
    //    /// <summary>
    //    /// 補件狀態
    //    /// </summary>
    ...
    ///// 檔案預覽
    ///// </summary>
    //public class Apply_005003PreviewModel : ApplyModel
    //{
