...
namespace ES.Areas.Admin.Models
{
    ...
    public class Apply_006001ViewModel
    {
        ...
        /// 
        /// </summary>
        public Apply_006001FormModel Detail { get; set; }
    ...
    public class Apply_006001FormModel : ApplyModel
    {
        ...
        public Apply_006001FileModel FileList { get; set; }
    ...
    /// 檔案下載
    /// </summary>
    public class Apply_006001FileModel
    {
