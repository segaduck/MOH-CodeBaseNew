...
namespace ES.Areas.Admin.Models
{
    ...
    public class Apply_001035FormModel : Apply_001035Model
    {
        ...
        [Display(Name = "申請人")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle_group = 1, group = 2)]
        ...
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle = true, block_toggle_id = "BaseData2", toggle_name = "納稅義務人資料", block_toggle_group = 2)]
        ...
        [Display(Name = "聯絡人姓名")]
        [Required]
        [Control(Mode = Control.TextBox, IsOpenNew = true, block_toggle = true, block_toggle_id = "BaseData3", toggle_name = "申辦資料", block_toggle_group = 3)]
        ...
        [Display(Name = "起始日期")]
        [Required]
        [Control(Mode = Control.DatePicker, IsOpenNew = true, block_BIG_id = "IMPORT", block_toggle = true, toggle_name = "進口資料", block_toggle_group = 4, group = 10, block_toggle_id = "DestIn")]
        public string Dest_DATE_S_AD
        {
            get
            {
                if (DATE_S == null)
        ...
        [Display(Name = "終止日期")]
        [Required]
        [Control(Mode = Control.DatePicker, IsOpenNew = true, block_toggle_group = 4, group = 10)]
        public string Dest_DATE_E_AD
        {
            get
            {
                if (DATE_E == null)
        ...
        [Display(Name = "起始日期")]
        [Required]
        [Control(Mode = Control.DatePicker, IsOpenNew = true, block_BIG_id = "EXPORT", block_toggle = true, toggle_name = "出口資料", block_toggle_group = 5, group = 20, block_toggle_id = "SellOut")]
        public string Sell_DATE_S_AD
        {
            get
            {
                if (DATE_S == null)
        ...
        [Display(Name = "終止日期")]
        [Required]
        [Control(Mode = Control.DatePicker, IsOpenNew = true, block_toggle_group = 5, group = 20)]
        public string Sell_DATE_E_AD
        {
            get
            {
                if (DATE_E == null)
        ...
        #region 貨品資料
        [Control(Mode = Control.Goods, IsOpenNew = true, block_toggle_id = "ProductData", block_toggle_group = 6, block_toggle = true, toggle_name = "貨品資料", EditorViewName = "GoodsDynamicGrid001035")]
        ...
        [Display(Name = "申請用途")]
        [Required]
        [Control(Mode = Control.DropDownList, IsOpenNew = true, block_toggle_id = "OtherData", block_toggle_group = 7, block_toggle = true, toggle_name = "其他資料")]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "申請單位同意試驗〈使用〉之文件或計畫摘要", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "20", block_toggle_group = 7)]
        public string DOC_COD_01 { get; set; }
        /// <summary>
        /// 檢附文件說明一
        /// </summary>
        [Display(Name = "檢附文件說明一")]
        [Control(Mode = Control.TextArea, IsOpenNew = true, columns = 30, rows = 5, block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型一", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "輸出國主管機關同意輸出文件或足以證明輸出國未管制輸出文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "貨品之檢驗證明文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型三", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "來源單位合法設立證明文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型四", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "來源單位證明捐贈者同意捐贈之文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型五", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "與貨品輸入單位合作之相關證明文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型六", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "來本署藥政處藥品臨床試驗許可函(如進行藥物臨床試驗者必備)", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型七", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "捐贈者年齡、器官、組織或細胞摘取時間等資料(進口眼角膜得於輸入後一個月內補正)", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型八", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "教學課程計畫書", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型九", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "藥物臨床試驗許可函", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "臨床試驗摘要", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十一", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "檢體數量概估說明(表)", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十二", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "IRB審核通過之國外擔保書", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十三", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "捐贈者同意文件（或來源單位證明捐者同意捐贈之文件）", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十四", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "捐贈者同意範例文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十五", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "與單位合作之相關證明文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十六", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "研究單位同意試驗文件（如：IRB許可函）", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十七", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "輸入貨品之檢驗證明文件或無污染證明文件", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十八", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "藥物臨床試驗許可函及/或試驗計畫摘要", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型十九", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "原核准輸出同意函", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "細胞治療技術施行計畫核准函", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "21", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十一", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "細胞製備場所GTP認可函", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "22", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十二", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.CheckBox, onChangeFun = "doDocCheck($(this))", IsOpenNew = true, checkBoxWord = "其他", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.TextBox, IsOpenNew = true, size = "23", block_toggle_group = 7)]
        ...
        [Control(Mode = Control.FileUpload, IsOpenNew = true, HoverFileName = "檢附文件類型二十三", block_toggle_group = 7)]
        ...
        /// </summary>
        [Display(Name = "檔案打包下載")]
        [Control(Mode = Control.ZipButton, CaseName = "非感染性人體器官、組織及細胞進出口申請作業", block_toggle_group = 7)]
        ...
        #region 案件歷程
        [Display(Name = "案件進度")]
        [Control(Mode = Control.Lable, block_toggle = true, block_toggle_id = "StatusData", toggle_name = "案件進度歷程", IsOpenNew = true, block_toggle_group = 8)]
        ...
        [Display(Name = "案件狀態修改")]
        [Required]
        [Control(Mode = Control.DropDownList, block_toggle_group = 8)]
        ...
        [Display(Name = "案件歷程紀錄")]
        [Control(Mode = Control.Log, IsOpenNew = true, block_toggle_group = 8, LogSchema = "APPLY_001035_GOODS")]
