...
namespace ES.Areas.Admin.Models
{
    ...
    public class Apply_011002ViewModel
    {
        ...
        /// 
        /// </summary>
        public Apply_011002FormModel Detail { get; set; }

        ///// <summary>
        ///// 
        ///// </summary>
        //public Apply_011002PreviewModel Preview { get; set; }
    ...
    /// 表單填寫
    /// </summary>
    public class Apply_011002FormModel : ApplyModel
    {       
        /// <summary>
        /// 
        /// </summary>
        ...
        public Apply_011002FileModel FileList { get; set; }
    }

    /// <summary>
    /// 檔案下載
    /// </summary>
    public class Apply_011002FileModel
    {
        public Apply_011002FileModel()
        {
