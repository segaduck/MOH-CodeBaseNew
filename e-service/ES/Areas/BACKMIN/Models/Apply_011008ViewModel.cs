...
namespace ES.Areas.Admin.Models
{
    ...
    public class Apply_011008ViewModel
    {
        ...
        /// 
        /// </summary>
        public Apply_011008FormModel Detail { get; set; }
    ...
    public class Apply_011008FormModel : ApplyModel
    {
        ...
        [Display(Name = "申請類別")]
        public string APPLY_TYPE_TXT { get; set; } 
        ...
        public Apply_011008FileModel FileList { get; set; }
    }

    /// <summary>
    /// 檔案下載
    /// </summary>
    public class Apply_011008FileModel
    {
